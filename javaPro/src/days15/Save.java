...
public class Save {
	...
	// [ Method Area ]
	// 클래스  변수  / 생성시기 ( 프로그램 시작 ) / 소멸시기 ( 프로그램 종료 )
	// static 변수
	// 정적 변수
	// 공유( shared ) 변수
	private  static  double rate = 0.05; // 이자율   8바이트 
	...
	*/ 
	...
	public static void setRate(double rate) {
		 // 1) 지역변수 사용할 수 있을 까요?있다.
		int n = 100;
		String s = "aa";
		
		// 2) 인스턴스 변수를 사용할 수 있을까요? 사용할 수 없다.  
		// Cannot make a static reference to the non-static field name
		// name ="홍씨";
		
		// 3) this 키워드 사용할 수 있을까요 ? 사용할 수 없다. 
		// 왜 ? this  생성된 객체(인스턴스)의 자기자신의 주소값을 갖는 참조변수
