...
public class Ex04 {
	...
	public static void main(String[] args) {
		 ...
		 * - 어노테이션 뜻 : 주석, 메모 
		 * - 형식 :   @어노테이션명
		 * -     자바 주석 처리            //                    /* ~ * /                /**    소스코드의 주석으로부터 javadoc.exe 툴을 사용해서 html문서 생성.     ~ * /
		 ...
		 *      3) @Deprecated  : 앞으로 사용하지 않는 것 나타내는 어노테이션
		 *      4) @FunctionInterface : 함수형 인터페이스라른 것을 알리는 어노테이션.           => 람다식
		 *      5) @SafeVarargs  : 제네릭 타입의 가변인자에 사용하는 어노테이션.      
		 *                                           대상(  메서드, 생성자) 에만 사용할 수 있는 어노테이션
		 *      6) @Navtive : native메서드에서 참조되는 상수 앞에 붙인다. 
		 *                                C 언어 메서드
		 *                                
		 *      [ 어노테이션 사용되는 어노테이션. ]                           
