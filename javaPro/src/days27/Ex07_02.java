...
import days27.Ex03.Direction;

/**
 * @author ♈ k§nik
 * @date 2023. 3. 6. - 오후 2:35:13
 * @subject    [ String[Reader] / String[Writer]  메모리 스트림 ]
 * @content
 *
 */
public class Ex07_02 {
	...
	public static void main(String[] args) {
		...
		// [문제]  source 문자열에서 [15번째 라인의] 문자열을 출력하는 코딩을 하세요. 
		//  결과 :  "            enum Direction { "
		// 2: 45 풀이~
		/*
		String regex = "\r\n";
		...
		*/
		...
		// 라인단위로 처리할 수 있는 보즈스트림 : BufferedReader
		
		// 문자열source ->  StringReader 메모리스트림 in  -> 라인처리 ->  BufferedReader 보조스트림 
		try (
			...
			System.out.println( line15 );  // 	enum Direction { 
