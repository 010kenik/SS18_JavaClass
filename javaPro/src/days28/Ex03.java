...
public class Ex03 {
	...
	public static void main(String[] args) {
		 ...
		 *     역직렬화?                          <-
		 *     
		 *  2.  객체를 직렬화해서 읽기/쓰기할 수 있는 바이트 스트림 
...
class UserInfo implements Serializable{	
	...
	// (기억) Object obj =new Object(); // Object 객체 obj는 직렬화 할 수 없다. 
	// (기억) Object obj = new String("admin"); // String 객체 obj는 직렬화 할 수 있다. 
